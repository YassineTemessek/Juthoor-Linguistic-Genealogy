...
def build_steps(*, python_exe: str, repo_root: Path, resources_dir: Path | None) -> list[Step]:
    ...
    return [
        ...
        Step(
            ...
            required_all_inputs=(arabic_sources / "word_root_map_raw.jsonl",),
        ...
        Step(
            ...
            cmd=[
                ...
                "--output",
                str(arabic_sources / "hf_roots.jsonl"),
            ],
            required_all_inputs=(
                (resources_root / "arabic" / "arabic_roots_hf" / "train-00000-of-00001.parquet")
                if resources_dir is None
        ...
        *[
            ...
            for lang_code, lang_tag, src_subpath, out_subpath in [
                ...
                ("he", "hebrew",
                 "hebrew/kaikki.org-dictionary-Hebrew.jsonl",
                 "hebrew/sources/kaikki.jsonl"),
                ("fa", "persian",
                 "persian/kaikki.org-dictionary-Persian.jsonl",
                 "persian/modern/sources/kaikki.jsonl"),
                ("arc", "aramaic",
