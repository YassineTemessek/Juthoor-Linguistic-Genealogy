    ...
    return [
        ...
        Step(
            ...
            cmd=[
                ...
                "--output",
                str(data_processed / "_intermediate" / "quranic_arabic" / "quran_lemmas_raw.jsonl"),
            ],
            required_all_inputs=(data_raw / "arabic" / "quran-morphology" / "quran-morphology.txt",),
            outputs=(data_processed / "_intermediate" / "quranic_arabic" / "quran_lemmas_raw.jsonl",),
        ),
        Step(
            ...
            cmd=[
                ...
                str(data_processed / "_intermediate" / "quranic_arabic" / "quran_lemmas_raw.jsonl"),
                "--output",
                str(data_processed / "quranic_arabic" / "sources" / "quran_lemmas_enriched.jsonl"),
            ],
            required_all_inputs=(data_processed / "_intermediate" / "quranic_arabic" / "quran_lemmas_raw.jsonl",),
            outputs=(data_processed / "quranic_arabic" / "sources" / "quran_lemmas_enriched.jsonl",),
        ),
        Step(
            name="quranic_arabic:merge_lexemes",
            tags=frozenset({"quranic_arabic"}),
            cmd=[python_exe, str(SCRIPTS_DIR / "merge_quranic_arabic_lexemes.py")],
            required_all_inputs=(data_processed / "quranic_arabic" / "sources" / "quran_lemmas_enriched.jsonl",),
            outputs=(data_processed / "quranic_arabic" / "lexemes.jsonl",),
        ),
        Step(
            ...
            cmd=[
                ...
                "--output",
                str(data_processed / "arabic" / "classical" / "sources" / "word_root_map_raw.jsonl"),
            ],
            required_all_inputs=(word_root_map_csv,),
            outputs=(data_processed / "arabic" / "classical" / "sources" / "word_root_map_raw.jsonl",),
        ),
        Step(
            name="arabic:clean_word_root_map",
            tags=frozenset({"arabic"}),
            cmd=[python_exe, str(SCRIPTS_DIR / "clean_word_root_map.py")],
            required_all_inputs=(data_processed / "arabic" / "classical" / "sources" / "word_root_map_raw.jsonl",),
            outputs=(data_processed / "arabic" / "classical" / "sources" / "word_root_map_filtered.jsonl",),
        ),
        Step(
            ...
            cmd=[
                ...
                "--output",
                str(data_processed / "arabic" / "classical" / "sources" / "hf_roots.jsonl"),
            ],
            required_all_inputs=(hf_roots_parquet,),
            outputs=(data_processed / "arabic" / "classical" / "sources" / "hf_roots.jsonl",),
        ),
        Step(
            name="arabic:merge_classical_lexemes",
            tags=frozenset({"arabic"}),
            cmd=[python_exe, str(SCRIPTS_DIR / "merge_arabic_classical_lexemes.py")],
            required_any_inputs=(
                data_processed / "arabic" / "classical" / "sources" / "word_root_map_filtered.jsonl",
                data_processed / "arabic" / "classical" / "sources" / "hf_roots.jsonl",
            ),
            outputs=(data_processed / "arabic" / "classical" / "lexemes.jsonl",),
        ),
        Step(
