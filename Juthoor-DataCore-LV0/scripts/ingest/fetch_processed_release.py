...
DEFAULT_REPO = "YassineTemessek/Juthoor-Linguistic-Genealogy"
...
def download(url: str, out_path: Path) -> DownloadResult:
    ...
    req = urllib.request.Request(url, headers={"User-Agent": "Juthoor-Linguistic-Genealogy/processed-fetch"})
