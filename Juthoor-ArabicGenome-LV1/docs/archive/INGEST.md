...
LV1 does not own ingest anymore.
...
LV1 consumes processed datasets (for example, a binary-root lexicon JSONL) and focuses on clustering/regrouping + graph exports.
