...
FEATURE_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "إمساك": ("منع", "منعه", "صد", "الصد"),
    "امتساك": ("تمكن", "التمكن", "رسوخ", "الرسوخ", "ثبات", "الثبات"),
    "خروج": ("انبثاق", "انطلاق", "تفجر", "التفجر", "فوران", "الفوران"),
    "امتداد": ("تزايد", "التزايد"),
    "انتقال": ("تحرك", "التحرك", "رجوع", "الرجوع"),
    "وصول": ("بلوغ", "البلوغ"),
    "ظهور": ("اتضاح", "كشف", "انكشاف", "الانكشاف", "بدو", "بدوه", "التكوين الاول"),
    "بروز": ("تبرز",),
    "اتصال": ("وصل", "اتباع", "الاتباع"),
    "تلاصق": ("التصاق",),
    ...
    "صدم": ("ارتطام", "الارتطام"),
    "باطن": ("الصميم", "صميم", "اخفاء", "الاخفاء"),
    "ظاهر": ("خارج", "الخارج"),
    "عمق": ("العمق", "اغوار", "غور", "قعر"),
