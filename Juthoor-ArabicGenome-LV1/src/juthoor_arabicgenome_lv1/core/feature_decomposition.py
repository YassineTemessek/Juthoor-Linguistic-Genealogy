...
FEATURE_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "إمساك": ("منع", "منعه", "صد", "الصد", "قبض", "القبض", "انسداد", "الانسداد", "اخذ", "الأخذ", "التقاط", "الالتقاط"),
    "امتساك": ("تمكن", "التمكن", "رسوخ", "الرسوخ", "ثبات", "الثبات", "وثاقه", "وثاقة", "تركز", "التركز", "متانه", "المتانه", "تحصين", "التحصين"),
    "خروج": ("انبثاق", "انطلاق", "تفجر", "التفجر", "فوران", "الفوران"),
    "امتداد": ("تزايد", "التزايد", "بقاء", "البقاء", "دوام", "الديمومه", "الدوام", "اقامه", "الاقامه", "استمرار", "الاستمرار", "طويل", "يطول", "توالي", "النمو", "نمو", "زياده", "الزياده"),
    ...
    "اشتمال": ("احاطة", "الاحاطة", "تغطية", "التغطية", "تداخل", "التداخل", "غشيان", "الغشيان"),
    "احتواء": ("استعمال", "الاستعمال", "اضطمام", "الاضطمام", "غلاف", "الغلاف", "يغطيه", "يغمر", "تحوي", "يحوط", "احاطته"),
    "اتساع": ("انفتاح", "الحوز", "حوز", "مجال", "انبساط", "الانبساط"),
    "نفاذ": ("منفذ", "المنفذ", "ولوج"),
    "خلوص": ("التجرد", "خلاصه", "خلاصته", "نقاء", "النقاء", "استخلاص", "الاستخلاص"),
    "اختراق": ("شق", "الشق", "فتح", "الفتح", "خرق", "الخرق"),
    ...
    "قطع": ("صدع", "الصدع"),
    "حدة": ("حاد", "حادة"),
    "باطن": ("الصميم", "صميم", "اخفاء", "الاخفاء", "استتار", "الاستتار", "غياب", "الغياب", "تغطي", "التغطي", "انغماس", "الانغماس", "دس", "حجب", "الحجب", "اسفل", "الاسفل", "منخفض", "منخفضا", "مهواه", "مهواة"),
    ...
    "تعقد": ("الثني", "ثني", "الانثناء", "انثناء", "انعطاف", "الانعطاف", "انحناء", "الانحناء", "اعوجاج", "الاعوجاج", "استداره", "الاستداره", "استدارة"),
    "استرسال": ("منسحب", "منسحبًا", "انسحاب", "الانسحاب", "جريان", "الجريان", "سريان", "السريان", "جيشان", "الجيشان"),
}
